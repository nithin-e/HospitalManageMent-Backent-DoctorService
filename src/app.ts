...
const StoreAppointmentSlotsService = new storeAppointmentSlotsService(
  StoreAppointmentSlotsRepo
);
const StoreAppointmentSlotsController = new storeAppointmentSlotsController(
  StoreAppointmentSlotsService
);

// Initialize dependency chain for fectingappointmentslotes
const FetchingAppontMentSlotesRepo = new fetchingAppontMentSlotesRepo();
const FetchAppontMentSlotesService = new fetchAppontMentSlotesService(
  FetchingAppontMentSlotesRepo
);
const FetchAppontMentSlotesController = new fetchAppontMentSlotesController(
  FetchAppontMentSlotesService
);
...
grpcServer.addService(DoctorProto.DoctorService.service, {
  ...
  fetchingAppontMentSlotes:
    FetchAppontMentSlotesController.fetchAppointmentSlots,

  StoreAppointMent: FetchAppontMentSlotesController.makeAppointment,

  fectingUserAppointMents:
    FetchAppontMentSlotesController.fetchUserAppointments,

  fectingAllUserAppointMents:
    FetchAppontMentSlotesController.fetchAllUserAppointments,

  RescheduleAppointment: StoreAppointmentSlotsController.rescheduleAppointment,

  CancelUserAppointMent:
    StoreAppointmentSlotsController.cancelAppointmentUserSide,

  StoreMessage: ChatHandlingController.storeMessage,

  fetchingConversations: ChatHandlingController.fetchConversations,

  AppointmentCancelingDueToUser:
    FetchAppontMentSlotesController.cancelUserAppointment,

  AfterTheConsultationUpdatingAppointMent:
    ChatHandlingController.updateAppointmentAfterConsultation,
  ...
  doctorCancellingUserBookedAppointMent:
    StoreAppointmentSlotsController.doctorCancelAppointment,
...
const startGrpcServer = () => {
  ...
  console.log(`Preparing to start gRPC Doctor server on ${serverAddress}`);
