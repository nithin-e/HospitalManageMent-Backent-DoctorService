...
doctorRoute.post(
    ...
    appointmentController.fetchAllUserAppointments
);
doctorRoute.post(
    '/fectingAppointMent',
...
doctorRoute.post(
    '/CancelingUserAppointMent',
    appointmentController.cancelAppointmentUserSide
);
doctorRoute.get(
    '/doctorAppointmentPagination',
    appointmentController.filteringDoctorAppointments
);
...
doctorRoute.post(
    ...
    priscriptionController.fetchPrescription
);
...
doctorRoute.post(
    '/fectingAppointMentSlotes',
    slotManagementController.fetchAppointmentSlots
);
doctorRoute.post(
    '/fetchDoctorSlots',
    slotManagementController.fetchDoctorSlots
);
doctorRoute.post(
...
doctorRoute.post(
    '/appointment-slots',
    slotManagementController.storeAppointmentSlots
);
