...
import { IChatRepository } from "../repositories/interfaces/IChat.repository";
 ...
 container.bind<IAppointmentService>(TYPES.AppointmentService).to(AppontMentService)
 ...
 container.bind<IPrescriptionService>(TYPES.PriscriptionService).to(PrescriptionService)
